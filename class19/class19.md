...
ggplot(cdc, aes(x=year, y=cases)) +
  ...
  geom_vline(xintercept=2019, linetype="dashed", col="darkgreen") +
  geom_text(aes(x=1946, y=max(cases), label="wP",), col="blue", hjust=-0.5) +
  geom_text(aes(x=1996, y=max(cases), label="aP"), col="red", hjust=-0.5) +
  geom_text(aes(x=2019, y=max(cases), label="COVID"), col="darkgreen", hjust=1.1)
```
...
to that observed prior to the first wP vaccine introduction.
...
This is the goals of the CMI-PB project, linked
[here](https://www.cmi-pb.org/)
...
Lets have a peak at these new objects:
...
Dates can be really difficult to work with. The lubridate package makes
this much easier. It is part of the **tidayverse** that includes dpylr,
ggplot2, etc.
...
Lets look at some dates using my birthday.
...
``` r
time_length( today() - ymd("2001-11-28"),  "years")
```
...
> Q. How many isotypes are we measuring for all of these individuals?
...
Box plot of MFI_normalized vs antigen
...
```
    ...
    6 Not Hispanic or Latino Unknown or Not Reported    1987-01-01    2019-04-08
           dataset        age age_years
    1 2021_dataset 11785 days  32.26557
    2 2021_dataset 11785 days  32.26557
    3 2021_dataset 11785 days  32.26557
    4 2021_dataset 11785 days  32.26557
    5 2021_dataset 11785 days  32.26557
    6 2021_dataset 11785 days  32.26557
