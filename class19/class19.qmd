...
There is a lag and then cases rise with a ~3 year cycle perhaps similar to that observed prior to the first wP vaccine introduction.
...
This is the goals of the CMI-PB project, linked [here](https://www.cmi-pb.org/)
...
Dates can be really difficult to work with. The lubridate package makes this much easier. It is part of the **tidayverse** that includes dpylr, ggplot2, etc.
